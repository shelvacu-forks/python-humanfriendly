...
def test_parse_date():
    ...
    assertEqual((2016, 11, 30, 0, 47, 17), parse_date(u'2016-11-30 00:47:17'))
...
def test_format_size():
    ...
    assertEqual('4294967296 KiB', format_size(1024 ** 4 * 4, binary=True, force_unit='KiB'))
    assertEqual('4398046511104 bytes', format_size(1024 ** 4 * 4, binary=True, force_unit='bytes'))
